...
import {
  ...
  createActor,
} from 'declarations/EZYield_backend';
...
const StakingApp = () => {
  ...
  return (
    <div className=" flex justify-center items-center h-full flex-col mt-16 w-full">
      <div className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <button
            className="bg-purple-400 text-white py-2 px-4 rounded mt-8"
            onClick={handleLogin}
          >
            Login
          </button>
